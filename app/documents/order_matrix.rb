  ...
  def body
    ...
    each_order_article do |a|
      order_articles_data << [a.article.name,
                              ...
                              a.units,
                              order_article_version_per_unit(a)]
    end
    ...
    each_ordergroup_batch batch_size do |batch_groups, batch_results|
      ...
      each_order_article do |order_article|
        supplier = order_article.article_version.supplier
        ...
        row = [order_article.article_version.name, order_article_version_per_unit(order_article)]
