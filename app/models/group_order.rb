    ...
    order.articles_grouped_by_category.each do |article_category, order_articles|
      order_articles.each do |order_article|
        ...
        data[:order_articles][order_article.id] = {
          ...
          :minimum_order_quantity => order_article.article_version.minimum_order_quantity ? order_article.article_version.convert_quantity(order_article.article_veorder_article.article_version.antity, order_articleorder_article.article_version.r_unit, order_article.article.group_order_unit) : nil
        }
      end
    end
