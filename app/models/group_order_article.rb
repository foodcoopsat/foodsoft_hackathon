...
class GroupOrderArticle < ApplicationRecord
  ...
  def calculate_result(total = nil)
    ...
    if not total.nil?
      ...
      total = order_article.article_version.convert_quantity(order_article.units_order_article.article_version.e.article.supplier_ororder_article.article_version.e.article.group_order_unit)
