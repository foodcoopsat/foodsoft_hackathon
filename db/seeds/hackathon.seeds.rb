...
Article.create!({ supplier_id: 1, quantity: 0 }).article_versions.create({ name: "Beer", article_category_id: 6, unit: nil, price: 52, tax: 7.0, deposit: "0.0", supplier_order_unit: "XCB", price_unit: "XBO", billing_unit: "XBO", group_order_unit: "XBO",
